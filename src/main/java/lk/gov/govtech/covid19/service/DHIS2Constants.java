...
public class DHIS2Constants {
    ...
    public final static String DISP_POSTALCODE = "Postal Code";
    public final static String DISP_STATEPROVINCE = "State Province";
    public final static String DISP_COUNTRY = "Address Country";
