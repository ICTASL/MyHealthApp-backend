...
new vue__WEBPACK_IMPORTED_MODULE_0___default.a({
  ...
  methods: {
    fetchData: function fetchData() {
      ...
      axios.get('/application/dashboard/status').then(function (response) {
    ...
    Update: function Update() {
      ...
      var url = "/application/dashboard/status";
      axios.put(url, {
...
module.exports = __webpack_require__(/*! /Users/KeraSL/DEV/OS/COVID-19/src/main/resources/js/dashboard.js */"./src/main/resources/js/dashboard.js");
