...
new vue__WEBPACK_IMPORTED_MODULE_0___default.a({
  ...
  methods: {
    fetchData: function fetchData() {
      ...
      axios.get('/api/application/dashboard/status').then(function (response) {
        return _this.lk_total_case = response.data.lk_total_case, _this.lk_recovered_case = response.data.lk_recovered_case, _this.lk_total_deaths = response.data.lk_total_deaths, _this.lk_total_suspect = response.data.lk_total_suspect, _this.last_update_time = response.data.last_update_time;
      });
    },
    ...
    CCshow: function CCshow() {
      this.fetchData();
      this.$modal.show('confirmed-cases');
    },
    CChide: function CChide() {
      this.$modal.hide('confirmed-cases');
      this.fetchData();
    },
    CCsubmit: function CCsubmit() {
      this.Update();
    },
    SSshow: function SSshow() {
      this.fetchData();
      this.$modal.show('suspected-cases');
    },
    SShide: function SShide() {
      this.$modal.hide('suspected-cases');
      this.fetchData();
    },
    SSsubmit: function SSsubmit() {
      this.Update();
    },
    RRshow: function RRshow() {
      this.fetchData();
      this.$modal.show('recover-cases');
    },
    RRhide: function RRhide() {
      this.$modal.hide('recover-cases');
      this.fetchData();
    },
    RRsubmit: function RRsubmit() {
      this.Update();
    },
    DDshow: function DDshow() {
      this.fetchData();
      this.$modal.show('deaths-cases');
    },
    DDhide: function DDhide() {
      this.$modal.hide('deaths-cases');
      this.fetchData();
    },
    DDsubmit: function DDsubmit() {
      this.Update();
    },
    Update: function Update() {
      var _this2 = this;

      var url = "/api/application/dashboard/status";
      axios.put(url, {
...
/***/ 2:
/*!**************************************************!*\
  !*** multi ./src/main/resources/js/dashboard.js ***!
  \**************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! /home/subhashinie/Documents/Projects/COVID-19/src/main/resources/js/dashboard.js */"./src/main/resources/js/dashboard.js");
