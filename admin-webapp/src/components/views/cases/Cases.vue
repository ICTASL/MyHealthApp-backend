                    ...
                    <div class="mt-8">
                        ...
                        <div class="px-4">
                            ...
                            <div v-if="$v.cases.message_en.$dirty">
                                ...
                                <p class="text-red-500 text-xs italic" v-if="!$v.cases.message_en.maxLength">English Message must have at most 2500 characters</p>
                    ...
                    <div class="mt-8">
                        ...
                        <div class="px-4">
                            ...
                            <div v-if="$v.cases.message_si.$dirty">
                                <p class="text-red-500 text-xs italic" v-if="!$v.cases.message_si.maxLength">Sinhala Message must have at most 2500 characters</p>
                    ...
                    <div class="mt-8">
                        ...
                        <textarea rows="2" class=" bg-white appearance-none border-2 border-gray-200 rounded w-full py-2 mt-2 px-4 text-gray-700 leading-tight focus:outline-none focus:outline-none focus:shadow-outline-blue focus:border-blue-300 focus:z-10 sm:text-sm sm:leading-5"
                            ...
                            <div v-if="$v.cases.message_ta.$dirty">
                                <p class="text-red-500 text-xs italic" v-if="!$v.cases.message_ta.maxLength">Tamil Message must have at most 2500 characters</p>
                            </div>
                        </div>
                    </div>
                </div>
